...
// //se declara boton siguiente, para acceder a "ejercicio2.html"
...
// Agrega un evento de 'mouseenter' a cada elemento
elements.forEach(element => {
  element.addEventListener('mouseover', () => {
    // Cambia el color de fondo del elemento a un color aleatorio
    element.style.backgroundColor = getRandomColor();
  });
